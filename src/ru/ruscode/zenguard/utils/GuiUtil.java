...
public class GuiUtil {
    public static InventoryView mainGui(Player p){
        ...
        final ItemBuilder reload = new ItemBuilder(Material.BOOK).setTitle(ChatUtil.fix(ConfigUtils.getString("gui.reload.name"))).addLore(ChatUtil.fix(ConfigUtils.getString("gui.reload.lore")));
